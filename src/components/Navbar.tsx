              ...
              <div className="hidden md:flex items-center space-x-8">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Link
                      href="/contact"
                      className="group relative inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white overflow-hidden rounded-lg transition-all duration-300"
                    >
              ...
              >
                <div className="px-6 pt-2 pb-4 space-y-1">
                  ...
                  >
                    <Link
                      href="/contact"
                      className="group relative block w-full px-4 py-2 text-base font-medium text-center text-white overflow-hidden rounded-lg transition-all duration-300"
                      onClick={() => setIsOpen(false)}
                    >
                      <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-blue-600 to-blue-500 transition-all duration-300 group-hover:scale-[1.02]" />
                      <span className="relative">Get Started</span>
                    </Link>
                  </motion.div>
                </div>
